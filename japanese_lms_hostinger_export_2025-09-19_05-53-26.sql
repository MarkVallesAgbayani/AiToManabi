...
-- Generated on: 2025-09-19 05:53:26 (Philippines Time)
...
-- Create database
CREATE DATABASE IF NOT EXISTS `japanese_lms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `japanese_lms`;
...
-- Dumping data for table `admin_permissions_by_category`
LOCK TABLES `admin_permissions_by_category` WRITE;
/*!40000 ALTER TABLE `admin_permissions_by_category` DISABLE KEYS */;
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_audit_trails', 'audit_export_pdf', 'Export audit trails to PDF', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_audit_trails', 'audit_search_filter', 'Search and filter audit trails', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_audit_trails', 'audit_view_details', 'View audit trail details', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_audit_trails', 'audit_view_metrics', 'View audit trail metrics (Total Actions, Actions Today, Failed Actions, Active Users)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_content_management', 'content_manage_announcement', 'Manage announcement banner', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_content_management', 'content_manage_privacy', 'Manage privacy policy', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_content_management', 'content_manage_terms', 'Manage terms and conditions', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_course_management', 'course_add_category', 'Add new course category', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_course_management', 'course_delete_category', 'Move course categories to trash', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_course_management', 'course_edit_category', 'Edit course categories', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_course_management', 'course_view_categories', 'View course categories table', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_dashboard', 'dashboard_view_course_completion', 'View course completion report card', '2', '2');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_dashboard', 'dashboard_view_metrics', 'View dashboard metrics cards (Total Students, Teachers, Modules, Revenue)', '2', '2');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_dashboard', 'dashboard_view_sales_report', 'View sales report card', '2', '2');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_dashboard', 'dashboard_view_user_retention', 'View user retention report card', '2', '2');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_login_activity', 'broken_links_export_pdf', 'Export broken links to PDF', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_login_activity', 'broken_links_view_report', 'View broken links report card', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_login_activity', 'login_activity_export_pdf', 'Export login activity to PDF', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_login_activity', 'login_activity_view_metrics', 'View login activity metrics (Total Logins Today, Failed Attempts, Broken Links)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_login_activity', 'login_activity_view_report', 'View login activity report card', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_audit_trails', 'Access to audit trails', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_content_management', 'Access to content management system', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_course_management', 'Access to course management system', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_dashboard', 'Access to admin dashboard', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_error_logs', 'Access to system error logs', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_login_activity', 'Access to login activity reports', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_payment_history', 'Access to payment history management', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_payments', 'Access to payment history', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_performance_logs', 'Access to performance logs', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_reports', 'Access to reports section', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_security_warnings', 'Access to security warnings', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_usage_analytics', 'Access to usage analytics reports', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_user_management', 'Access to user management system', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_navigation', 'nav_user_roles_report', 'Access to user roles breakdown report', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_payment_history', 'payment_view_history', 'View payment history table', '2', '2');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_security_warnings', 'security_view_admin_activity', 'View unusual admin activity', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_security_warnings', 'security_view_metrics', 'View security metrics (Failed Logins, Suspicious IPs, Admin Actions, New Users)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_security_warnings', 'security_view_recommendations', 'View security recommendations', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_security_warnings', 'security_view_suspicious_patterns', 'View suspicious login patterns', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_error_logs', 'error_logs_export_pdf', 'Export error logs to PDF', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_error_logs', 'error_logs_search_filter', 'Search and filter error logs', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_error_logs', 'error_logs_view_categories', 'View error categories breakdown', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_error_logs', 'error_logs_view_metrics', 'View error log metrics (AI Failures, Response Time, Critical Errors, Total Errors)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_error_logs', 'error_logs_view_trends', 'View error trends chart (7 days)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_performance', 'performance_view_load_times', 'View average page load times', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_performance', 'performance_view_metrics', 'View system performance metrics (System Status, Uptime, Load Time, Total Requests)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_system_performance', 'performance_view_uptime_chart', 'View uptime vs downtime chart (7 days)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_usage_analytics', 'analytics_export_pdf', 'Export analytics data to PDF', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_usage_analytics', 'analytics_view_active_trends', 'View active users trend card', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_usage_analytics', 'analytics_view_activity_data', 'View detailed activity data card', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_usage_analytics', 'analytics_view_metrics', 'View analytics metrics cards (Active Users, Daily Average, Peak Day, Growth Rate)', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_usage_analytics', 'analytics_view_role_breakdown', 'View user role breakdown card', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_management', 'user_add_new', 'Add new user with custom roles', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_management', 'user_ban_user', 'Ban/unban users', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_management', 'user_change_password', 'Change user passwords', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_management', 'user_change_role', 'Change user roles', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_management', 'user_move_to_deleted', 'Move users to deleted status', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_management', 'user_reset_password', 'Reset user passwords', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_roles_report', 'user_roles_export_pdf', 'Export user roles report to PDF', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_roles_report', 'user_roles_search_filter', 'Search and filter users in roles report', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_roles_report', 'user_roles_view_details', 'View user roles report details', '2', '0');
INSERT INTO `admin_permissions_by_category` (`category`, `permission_name`, `description`, `template_count`, `custom_assignment_count`) VALUES ('admin_user_roles_report', 'user_roles_view_metrics', 'View user roles metric cards (Admins, Teachers, Students)', '2', '0');
/*!40000 ALTER TABLE `admin_permissions_by_category` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dumping data for table `user_admin_permissions_summary`
LOCK TABLES `user_admin_permissions_summary` WRITE;
/*!40000 ALTER TABLE `user_admin_permissions_summary` DISABLE KEYS */;
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('1', 'admin', 'admin', 'Full Admin Access', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('4', 'marky123', 'admin', 'Full Admin Access', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('6', 'marky1234', 'admin', 'Full Admin Access', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('8', 'marky12345', 'admin', 'Full Admin Access', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('10', 'final123', 'admin', 'Full Admin Access', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('12', 'adminjapaneselms2', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('13', 'narjk123', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('14', 'adminlast', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('15', 'admin123', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('16', 'marku', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('17', 'adminaitomanabi', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('18', 'adminaitom', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('22', 'katri', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('23', 'usercreated', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
INSERT INTO `user_admin_permissions_summary` (`user_id`, `username`, `role`, `template_name`, `total_permissions`, `permission_categories`) VALUES ('32', 'asd1231234', 'admin', 'Default Permission', '62', 'admin_audit_trails,admin_content_management,admin_course_management,admin_dashboard,admin_login_activity,admin_navigation,admin_payment_history,admin_security_warnings,admin_system_error_logs,admin_system_performance,admin_usage_analytics,admin_user_management,admin_user_roles_report');
/*!40000 ALTER TABLE `user_admin_permissions_summary` ENABLE KEYS */;
UNLOCK TABLES;
...
('adminmark', 'adminmark@aitomanabi.com', '$2y$10$KCl4D2hQfrOuOOMiR8FVYexveZZhKAW0kHYKgdeTfQawfVZSGMDAG', 'admin', 'Admin', 'Mark', NOW(), NOW());

-- Assign Hybrid Admin role template to new admin
INSERT INTO `user_roles` (`user_id`, `template_id`, `created_at`)
SELECT u.id, rt.id, NOW()
FROM `users` u, `role_templates` rt
WHERE u.email = 'adminmark@aitomanabi.com' AND rt.name = 'Hybrid Admin';

-- Fallback: Assign Default Admin if Hybrid Admin doesn't exist
INSERT INTO `user_roles` (`user_id`, `template_id`, `created_at`)
SELECT u.id, rt.id, NOW()
FROM `users` u, `role_templates` rt
WHERE u.email = 'adminmark@aitomanabi.com' AND rt.name = 'Default Admin'
AND NOT EXISTS (
    SELECT 1 FROM `user_roles` ur2 
    JOIN `users` u2 ON ur2.user_id = u2.id
    WHERE u2.email = 'adminmark@aitomanabi.com'
);
