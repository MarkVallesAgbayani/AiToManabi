 ...
 * Handles OTP verification for password changes and other operations
 */
...
try {
    ...
    error_log("OTP Verification - User ID: " . $_SESSION['user_id'] . ", OTP: " . $otp_code . ", Type: " . $type);
    ...
    if ($otp) {
        error_log("OTP found and valid - ID: " . $otp['id']);
        ...
        if ($type === 'password_change') {
            try {
                error_log("Processing password change verification");
                ...
                if ($tempPassword) {
                    error_log("Temporary password found, updating user password");
                    ...
                    error_log("No temporary password found or expired");
                    echo json_encode([
                        'success' => false, 
        ...
        error_log("OTP not found or invalid - User ID: " . $_SESSION['user_id'] . ", OTP: " . $otp_code);
        echo json_encode([
            'success' => false, 
