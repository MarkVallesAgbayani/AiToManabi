...
function shareTerms() {
    if (navigator.share) {
        navigator.share({
            title: 'Terms & Conditions - AiToManabi',
...
// Search functionality for terms content
...
console.log('%c📄 Terms & Conditions Page Loaded', 'color: #dc2626; font-size: 16px; font-weight: bold;');
console.log('%cAiToManabi Legal Documentation', 'color: #6b7280; font-size: 12px;');
