 ...
 * Handles password change form with strength validation and OTP verification
 */
...
class PasswordChangeManager {
    ...
    async testAPIConnection() {
        try {
            const response = await fetch('./api/test_api.php');
...
function togglePasswordVisibility(inputId) {
    if (window.passwordChangeManager) {
        window.passwordChangeManager.togglePasswordVisibility(inputId);
    }
}

function showPasswordTooltip() {
    if (window.passwordChangeManager) {
        window.passwordChangeManager.showPasswordTooltip();
    }
}

function hidePasswordTooltip() {
    if (window.passwordChangeManager) {
        window.passwordChangeManager.hidePasswordTooltip();
    }
}

function hideOTPModal() {
    if (window.passwordChangeManager) {
        window.passwordChangeManager.hideOTPModal();
    }
}
